 ...
 */
public class CommandHystrixPruebaSincrona extends HystrixCommand<String> {

    /** atributo que simulara un log */
    ...
    public CommandHystrixPruebaSincrona(String msg){
    ...
    public CommandHystrixPruebaSincrona(String msg, int retry){
        /** Se establece la configuracion inicial del proceso */
        super(getConfiguracio("pool"+msg));
        // Se establece la informacion de configuracion propia del negocio
        this.mensaje = msg;
    ...
    protected String getFallback() {
        ...
        try {
            ...
            if(retry <= 2){
                ...
                CommandHystrixPruebaSincrona nuevoComando = new CommandHystrixPruebaSincrona(this.mensaje, this.retry);
                ...
                log.append(nuevoComando.getLog());
                return resultado;
            }else{
